        ...
        <div style={{maxWidth:860,margin:"0 auto"}}>
          ...
          <div style={{background:"#FFF5F5",border:`1.5px solid #FCA5A5`,borderRadius:14,padding:22,marginBottom:24}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:10}}>
              {[
                {stage:"Stage 1",icon:"🟡",title:"First Miss",trigger:"Missed deadline",penalty:"−30 pts (Tier 1) · −150 pts (Tier 2) · −300 pts (Tier 3) · −600 pts (Tier 4)",ext:"+ 14-day extension",color:"#FEF3C7",border:"#FCD34D",tc:"#92400E"},
                  ...
                  <div>
                    ...
                    {(()=>{
                      ...
                      const monthsSinceSupport = lastApproved
                        ...
                        : null;
                      const priorityLabel = !lastApproved?"Highest Priority — Never received Essential Bill Support Funds"
