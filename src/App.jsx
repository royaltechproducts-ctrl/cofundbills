...
Answer warmly, concisely and accurately. Never invent information.`;
  ...
  const FAQS = [
    ...
    ["What is a Contribution Cell?","A contribution cell is a group of 10 contributing members who each pay ₦10,000/month for 10 months, plus up to 4 network position holders (Host, Anchor, Root, Founding Member) whose invite chains led to the cell's formation. Cell size ranges from 10 to 14 members depending on the depth of the invite chain above the contributing members."],
    ...
    ["How do I activate my membership?","After registering, pay ₦10,000 to: Royal Tech Partnership & Investment Limited, Zenith Bank, Account 1016621205. Use your link code as reference. WhatsApp +234 909 999 4816. Admin activates your account and you are automatically placed in a forming cell."],
  ];
  ...
  const Landing = () => (
    <>
      ...
      <div style={{background:C.navy,padding:"18px 24px",display:"flex",justifyContent:"center",gap:10,flexWrap:"wrap"}}>
        {[["₦10,000","Monthly Contribution"],["₦60,000","Cycle Payout/Member"],["10 Months","Contribution Cycle"],["10–14","Members Per Cell"],["1%–4%","Loan Rate/Month"],["60%","Benefit Pool Split"]].map(([v,l])=>(
